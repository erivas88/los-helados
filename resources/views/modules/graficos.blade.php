                        ...
                        <div class="flex-toolbar-container">
                            ...
                            <div class="filter-item">
                                ...
                                <select multiple id="filtro-estaciones" class="form-control selectpicker" title="Estaciones"
                                    data-size="5" data-live-search="true" data-width="100%"
                ...
                <div class="modal-body" style="padding: 25px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-3" style="background: #f0f7ff; padding: 12px; border-radius: 6px; border: 1px solid #d0e7ff;">
                                <label class="switch-container d-flex align-items-center justify-content-between" style="cursor:pointer; width: 100%;">
                                    <span style="font-weight: 700; color: #0056b3; text-transform: uppercase; font-size: 10px; letter-spacing: 0.5px;">Eje Secundario (Dual)</span>
                                    <div class="switch">
                                        <input type="checkbox" id="cfg-use-dual-axis">
                                        <span class="slider round"></span>
                                    </div>
                                </label>
                                <p class="text-muted mb-0" style="font-size: 9px; margin-top: 5px;">Habilite esta opción para graficar parámetros en escalas diferentes (Y1 e Y2).</p>
                            </div>
    ...
    <script>
        $(document).ready(function () {
                ...
                currentChart.yAxis.forEach((ax, i) => {
                    axisHTML += `
                        <div class="cfg-group-card">
                            ...
                            <div class="row">
                                <div class="col-xs-4"><label class="small text-muted">Lím. Sup</label><input type="number" class="form-control cfg-input-sm ax-u" data-idx="${i}" value="${ax.max || ''}"></div>
                                <div class="col-xs-4"><label class="small text-muted">Lím. Inf</label><input type="number" class="form-control cfg-input-sm ax-l" data-idx="${i}" value="${ax.min || ''}"></div>
            ...
            $(document).on('change', '.ax-u, .ax-l', function () {
                ...
                const max = parseFloat($(`.ax-u[data-idx="${i}"]`).val());
                const min = parseFloat($(`.ax-l[data-idx="${i}"]`).val());
                currentChart.yAxis[i].update({ max: isNaN(max) ? null : max, min: isNaN(min) ? null : min });
            });
